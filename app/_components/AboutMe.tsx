                    ...
                    <div className="md:col-span-7">
                        <div className="text-lg text-muted-foreground max-w-[450px]">
                            ...
                            <p className="mt-3 slide-up-and-fade">
                                ...
                                high-performing products that are easy to use
                                and accessible to all. By combining strong
                                functionality with clean, thoughtful design,
                                I strive to create solutions that not only
                                look good but also solve real problems for
